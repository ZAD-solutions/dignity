...
class ResPartnerInherit(models.Model):
    ...
    favourite_pastime = fields.Datetime('Favourite Pastime')
    ...
    medication = fields.Char('What is Medication are you on ?', )
    ...
    preferred_destination = fields.Selection([('sahel', 'Sa7el'),
                                              ('gouna', 'Gouna'),
                                              ('sokhna', 'Sokhna'),
                                              ('red_sea', 'Red Sea'),
                                              ('other', 'Other')])
    ...
    go_out_cairo = fields.Char('Where do you like fo out in Cairo ?', )
